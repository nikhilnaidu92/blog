...
public class ReminderEmailService {
  ...
  public void sendReminderEmails() {
    ...
    List<EmailRequestEntity> emailRequests =
      emailRequestRepository.findEmailRequestEntitiesByStatusTextOrStatusTextAndLastUpdateTimestampIsLessThan(
        "PENDING",
        "RESENT",
    ...
    for (EmailRequestEntity emailRequestEntity : emailRequests) {
      if (emailRequestEntity != null) {
        ...
        ravenEvent.getParams().put("eventType", "Reminder");
        ...
        emailRequestEntity.setStatusText("RESENT");
